...
public class RecyclerView2Adapter extends RecyclerView.Adapter<RecyclerView2Adapter.ViewHolder> {
    class ViewHolder extends RecyclerView.ViewHolder
        ...
        public void onClick(View view) {
            ...
            // view.getContext() -> view에 해당하는 Activity return
    ...
    @Override
    public RecyclerView2Adapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RecyclerView2Adapter.ViewHolder viewHolder, int position) {
